...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        tasks = wybieranieOpcji(FILE_NAME);
    ...
    public static String[][] wybieranieOpcji(String FileName2) {
        ...
        try {String tab[][] = tasks;
            ...
            if (dodajZmienna.equals("add")) {
                ...
                for (int i = 0; i < tab.length; i++) {
                    ...
                    System.out.println("Wpisz true/false");
                    String czyJestWazne = scanner.nextLine();
                    if (czyJestWazne.equals("true") && czyJestWazne.equals("false")) {
                        Files.writeString(path1, czyJestWazne, StandardOpenOption.APPEND);
                        main(OPTIONS);
                    } else {
                        System.out.println("Wpisz true/fase");
                        czyJestWazne = scanner.nextLine();
                    }
                }
